...
import type { EncounterDeck, TurnState, HeroHpState, EncounterCard, PartyResources } from "./types";
import { INITIAL_ENCOUNTER_DECK, ENCOUNTER_CARDS, ENCOUNTER_CANCEL_COST } from "./types";
...
describe("encounters", () => {
  ...
  describe("canCancelEncounter", () => {
    it("should return true when XP >= ENCOUNTER_CANCEL_COST", () => {
    ...
    it("should return false when XP < ENCOUNTER_CANCEL_COST", () => {
  ...
  describe("cancelEncounter", () => {
    it("should deduct ENCOUNTER_CANCEL_COST XP from party resources", () => {
      ...
      expect(result.resources.xp).toBe(6 - ENCOUNTER_CANCEL_COST);
      expect(result.resources.healingSurges).toBe(2); // Unchanged
    });

    it("should add encounter to discard pile", () => {
      const resources: PartyResources = { xp: 5, healingSurges: 2 };
      const deck: EncounterDeck = { drawPile: ['cave-in'], discardPile: ['dark-fog'] };
    ...
    it("should work with exactly ENCOUNTER_CANCEL_COST XP", () => {
      const resources: PartyResources = { xp: ENCOUNTER_CANCEL_COST, healingSurges: 2 };
      const deck: EncounterDeck = { drawPile: [], discardPile: [] };
