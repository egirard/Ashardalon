...
export const TILE_DEFINITIONS: TileDefinition[] = [
  ...
  { tileType: 'tile-black-2exit-b', imagePath: 'assets/Tile_Black_x2_02.png', defaultEdges: { north: 'wall', south: 'open', east: 'wall', west: 'open' }, isBlackTile: true, scorchMarkPosition: { x: 1, y: 2 } },  // S/W open, N/E walls
  { tileType: 'tile-black-2exit-c', imagePath: 'assets/Tile_Black_x2_03.png', defaultEdges: { north: 'wall', south: 'open', east: 'open', west: 'wall' }, isBlackTile: true, scorchMarkPosition: { x: 1, y: 2 } },  // S/E open, N/W walls
  ...
  { tileType: 'tile-white-3exit-b', imagePath: 'assets/Tile_White_x3_02.png', defaultEdges: { north: 'wall', south: 'open', east: 'open', west: 'open' }, isBlackTile: false, scorchMarkPosition: { x: 1, y: 2 } },  // S/E/W open, N wall
