...
When working on this repository, please read the [DEVELOPMENT.md](../DEVELOPMENT.md) file first to understand the development environment and available tools.
...
When writing E2E tests, follow [E2E_TEST_GUIDELINES.md](../E2E_TEST_GUIDELINES.md) **rigidly**:
