...
![The Echo of the Cursed Forge](assets/HeroScreen_CursedForge.png)
...
- **Dungeon Tile Stack:**
  - Find the Chamber Entrance tile and set it aside.
...
![Vraxos, the Cursed Sentinel](assets/Monster_Vraxos.png)

| Stat | Value |
|------|-------|
| **AC** | 18 |
| **HP** | 10 *(+5 HP per additional Hero)* |
